            ...
            <div class="col-md-12">
                ...
                <div class="card-footer">
                    ...
                    <div class="col-sm-4 border-right">
                        ...
                        <h5 class="description-header">Adviser</h5>
                        <span class="description-text">Prof. Name</span>
                        </div>
                        <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-4 border-right">
                        <div class="description-block">
                        <h5 class="description-header">Year and Section</h5>
                        <span class="description-text">1st - D</span>
                        </div>
                        <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-4">
                        ...
                        <span class="description-text">BSIT</span>
                        </div>
                        <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="information">
                                ...
                                <div class="form-group">
                                    <label for="profile_photo" class="col-sm-2 control-label">Profile Photo</label>
                                    <div class="col-sm-12">
                                        <input type="file" @change="updateProfile" name="profile_photo" class="form-input">
                                    </div>
